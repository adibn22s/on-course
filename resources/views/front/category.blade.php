            ...
            @auth
                <div class="flex gap-[10px] items-center">
                    <div class="flex flex-col items-end justify-center">
                        ...
                        @if(Auth::user()->hasActiveSubscriptions())
            ...
            <div class="grid grid-cols-3 gap-[30px] w-full">
                ...
                <div class="course-card">
                    <div class="flex flex-col rounded-t-[12px] rounded-b-[24px] gap-[32px] bg-white w-full pb-[10px] overflow-hidden ring-1 ring-[#DADEE4] transition-all duration-300 hover:ring-2 hover:ring-[#FF6129]">
                        <a href="{{ route('front.details', $c->slug) }}" class="thumbnail w-full h-[200px] shrink-0 rounded-[10px] overflow-hidden">
                        ...
                        <div class="flex flex-col px-4 gap-[32px]">
                            <div class="flex flex-col gap-[10px]">
                                <a href="{{ route('front.details', $c->slug) }}" class="font-semibold text-lg line-clamp-2 hover:line-clamp-none min-h-[56px]">{{ $c->name }}</a>
                                <div class="flex justify-between items-center">
                                    ...
                                    <p class="text-right text-[#6D7786]">{{ $c->students->count() }} students</p>
                                </div>
                            </div>
                            <div class="flex items-center gap-2">
                                <div class="w-8 h-8 flex shrink-0 rounded-full overflow-hidden">
                                    <img src="{{ Storage::url($c->teacher->user->avatar) }}" class="w-full h-full object-cover" alt="icon">
                                </div>
                                <div class="flex flex-col">
                                    <p class="font-semibold">{{ $c->teacher->user->name }}</p>
                                    <p class="text-[#6D7786]">{{ $c->teacher->user->occupation }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
